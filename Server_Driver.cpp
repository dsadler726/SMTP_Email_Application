...
int main(int argc, char *argv[]){
    ...
    if (argc < 2) error("Error, no file provided\n");
    ...
    SMTP_portno = lineData[1].substr(10);
    HTTP_portno = lineData[2].substr(10);

    //Welcome Message when starting the Server
    printf(" \n");
    cout << "Welcome to the Simple Email Server Application" << endl;
    cout << "Booting up servers..." << endl;
